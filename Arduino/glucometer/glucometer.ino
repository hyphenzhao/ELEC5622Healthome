...
void setup()
{
  ...
  sendMessageToServer(glucometer);
}
...
void sendMessageToServer(int glucometer) {
  ...
  else if (answer == 1)
  {
    ...
    if (sendATcommand("AT+CWJAP=\"Hiphone\",\"zhao123456\"", "OK", 20000))
    {
      ...
      if (sendATcommand("AT+CIPSTART=\"TCP\",\"172.20.10.2\",8000", "OK", 100000)) {
        ...
        sendATcommand("AT+CIPSEND=112", "OK", 100000);
        String httprequest = "GET /diabetes/arduino/?arduino_board_no=123456&glucose="+ String(glucometer) +" HTTP/1.1\r\nHost: 172.20.10.2:8000\r\nConnection: close\r\n";
